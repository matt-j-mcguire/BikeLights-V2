...
#define switchB 10  //Break input, solid input, mom push button
#define switchL 11  //left turn signal, mom push button, activate on 'up'
#define switchR 12  //Right turn signal, mom push button, activate on 'up'
#define switchH 9  //Headlight beam select, mom push button, activate on 'up'

#define FLTS 2      //front left turn signal
#define FRTS 3      //front right turn signal
#define HILOW 4     //high / low selector for headlight beam

#define RLTS 8     //rear left turn signal (outer ring)
#define RRTS 7      //rear right turn signal (outer ring)
#define RLBRK 6     //rear left break light (inner ring)
#define RRBRK 5     //rear right break light (inner ring)
...
void setup() {
  Serial.begin(9600);
  for (int i = 9; i < 13; i++) { //Inputs switchs held high
    pinMode(i, INPUT);
    digitalWrite(i, _off);
  }
